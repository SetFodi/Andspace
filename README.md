...
Final public screenshots will live in `docs/screenshots/final/` after capture.
The capture checklist is tracked in
[docs/screenshots/README.md](docs/screenshots/README.md).

<!--
Drop final screenshots here when captured:
...
![Servers section detecting localhost](docs/screenshots/final/06-servers.png)
...
| `02-command-guard.png` | Command Guard overlay |
| `03-ai-handoff.png` | `Cmd+E` AI handoff overlay |
| `04-command-palette.png` | `Cmd+K` command palette |
| `05-git-diff-preview.png` | Read-only Git Diff Preview |
