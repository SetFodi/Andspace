# AndSpace v0.1.0-alpha.3 Launch Assets Checklist
...
| Final video filename | Suggested: `andspace-v0.1.0-alpha.3-demo.mp4` |
...
| Release link target | `https://github.com/SetFodi/Andspace/releases/tag/v0.1.0-alpha.3` |
